...
QT_MOC_LITERAL(1, 8, 6), // "mudouX"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6), // "mudouY"
QT_MOC_LITERAL(4, 23, 12), // "setAmplitude"
QT_MOC_LITERAL(5, 36, 10), // "_amplitude"
QT_MOC_LITERAL(6, 47, 13), // "setFrequencia"
QT_MOC_LITERAL(7, 61, 11), // "_frequencia"
QT_MOC_LITERAL(8, 73, 13), // "setVelocidade"
QT_MOC_LITERAL(9, 87, 11) // "_velocidade"

    },
    "Plotter\0mudouX\0\0mudouY\0setAmplitude\0"
    "_amplitude\0setFrequencia\0_frequencia\0"
    "setVelocidade\0_velocidade"
};
...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mudouX((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->mudouY((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setAmplitude((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->setFrequencia((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->setVelocidade((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plotter::mudouX)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Plotter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plotter::mudouY)) {
                *result = 1;
                return;
            }
        }
